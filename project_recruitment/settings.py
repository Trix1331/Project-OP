"""
Django settings for project_recruitment project.
...
SECRET_KEY = 'django-insecure-f_24&*1&b1o#5+fo&oi1)3#970+hd^3j9bdo&^06u1pbs(z=$g'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # ваш шлях до статичних файлів
]
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Ц
